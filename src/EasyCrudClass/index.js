...
var KnexRepository_1 = require("../DatabaseRepositories/KnexRepository");
var EasyCrudClass = /** @class */ (function () {
    function EasyCrudClass(config) {
        ...
        this.dbRepository = new KnexRepository_1.KnexRepository(this.dbConnectionInstance, config.schema);
        this.exposeCrudRoutes();
    }
    EasyCrudClass.prototype.exposeCrudRoutes = function () {
        var _this = this;
        this.httpHandler.get("/" + this.config.routeName, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.dbRepository.getAll()];
                    case 1:
                        result = _a.sent();
                        if (result) {
                            res.send(result);
        ...
        this.httpHandler.post("/" + this.config.routeName, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.dbRepository.create(req.body)];
                    case 1:
                        result = _a.sent();
                        if (result) {
                            res.send(result);
